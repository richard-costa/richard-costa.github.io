...
Blog posts about Omarchy, an Arch-Linux based distro (or a bunch of configurations if you want to call it that way):

- [installing cosmic and changing sddm on omarchy](posts/1.cosmic-and-sddm-omarchy.qmd)
- [installing a calendar widget on omarchy](posts/2.calendar-omarchy.qmd)
