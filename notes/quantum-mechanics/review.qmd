...
# This note intentionally declares both formats here.
# Quarto will render qm_review.html and qm_review.pdf and expose
# the PDF under "Other Formats" on the HTML page.
format:
  html: default
  pdf:
